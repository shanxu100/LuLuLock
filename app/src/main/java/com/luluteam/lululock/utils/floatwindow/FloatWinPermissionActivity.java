...
import com.luluteam.lululock.activity.BaseActivity;
 ...
 */
@RuntimePermissions
public class FloatWinPermissionActivity extends BaseActivity {
    ...
    protected void needSystemAlertWindowPermissin() {
         ...
         * 开启悬浮窗
         */
        Intent floatWinIntent=new Intent(App.getAppContext(), FloatWindowSimpleService.class);
